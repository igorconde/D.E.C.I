...
export const project = {
    ...
    budgetDetails     : {
        ...
        rows   : [
            {
                id                 : 1,
                type: 'Ações Regressivas',
                total              : 14880,
                expensesAmount     : 14000,
                expensesPercentage : 41.08,
                remainingAmount    : 58.20,
                remainingPercentage: 95.92
            },
            {
                id                 : 2,
                type: 'Liminares',
                ...
                expensesPercentage : 40.78,
                remainingAmount    : 39.66,
                remainingPercentage: 78.22
            },
            {
                id                 : 3,
                type: 'Materiais',
                total              : 34720,
                expensesAmount     : 3518,
                expensesPercentage : 28.13,
                remainingAmount    : 31.02,
                remainingPercentage: 89.87
            },
            {
                id                 : 4,
                type: 'Procedimentos Médicos',
                total              : 18600,
                expensesAmount     : 0,
                expensesPercentage : 41.20,
                remainingAmount    : 18.00,
            ...
            },
            {
                ...
                expensesPercentage : 38.2,
                remainingAmount    : 14.6,
